...
const Card = () => {
  return (
    ...
    {/* mobile view */}
    <div className=" mt-16  m-auto  w-[96vw] h-[10vh] bg-zinc-800 hover:bg-zinc-900 shadow-lg shadow-gray-500/50     sm:hidden  text-white rounded-xl flex flex-col items-center">
